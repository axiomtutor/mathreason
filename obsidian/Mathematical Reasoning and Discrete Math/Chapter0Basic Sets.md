...
To express membership, we write an infix $\in$, like below.
...
> 
> We say that *a* is **the maximum** of *X* if *a* is an upper bound of *X* and also $a\in X$.
> 
...
> $$
> More generally if we have *n* sets, $A_1,A_2,…,A_n$, then their **set product** is
> $$
