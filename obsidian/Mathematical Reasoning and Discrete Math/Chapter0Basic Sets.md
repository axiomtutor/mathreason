...
We will return to discussing set theory in a deeper, even axiomatic way, later in this course. For now we will introduce just enough set theory to be able to use it while studying logic.
